...
export let REVIEWS: Review[] = [
    ...
    { course: "CSC209", reviewer: "yangray1", profName: "Mich Elle", overallRating: 4, difficulty: 1, workload: 1, hoursPerWeek: 3, textbookUsed: true, gradeReceived: "A+", writtenReview: "this course is so easy :) this review is hardcoded", score: 0 }
];
