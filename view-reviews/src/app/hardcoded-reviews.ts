...
export const REVIEWS: Review[] = [
    {reviewer: "Student", profName: "Michelle Craig", overallRating: 5, difficulty: 2, workload: 2, hoursPerWeek: 2, textbookUsed: false, gradeReceived: "A", writtenReview: "yatta!", score: 0},
